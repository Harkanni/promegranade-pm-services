...
export default function Home() {
   ...
   return (
      <main>
         <HeaderComponent>
            <h1 className='text-[55px] w-[75%] text-center dark:text-slate-200 break-words lg:tracking-wide leading-none lg:leading-[6rem] font-monteserat font-bold mb-3'>Digital marketing agency</h1>
            <div className='w-[350px] lg:w-[500px] h-[5rem] rounded-3xl absolute sm:bottom-[11rem] lg:bottom-[9.5rem] -z-10  bg-slate-300 dark:bg-pink-700'></div>
            ...
            <button className='mt-5 py-3 px-16 bg-slate-600 rounded-full text-white font-thin text-sm hover:bg-slate-700'>Read More</button>
         </HeaderComponent>

         <div className='w-full -space-x-10 flex flex-col md:flex-row justify-center items-center'>
            <motion.div
            ...
            >
               <Image
                  src={img1}
                  alt='img1'
                  className='w-[100%] h-[100%] object-cover rounded-[3rem] translate-y-20'
               />
            </motion.div>
         ...
         <div className='w-full h-[300px] p-20 bg-slate-200 dark:bg-slate-950'>
            <div className='w-[60%] h-full m-auto flex justify-between items-center'>
               {accolades.map((accolade, index) => (
                  <div key={index} className='flex flex-col items-center gap-5'>
                     <Counter from={0} to={accolade.num} extra={accolade.extra} />
                     <span className='dark:text-white'> {accolade.text} </span>
                  </div>
               ))}
            </div>
         </div>
         ...
         <section className='w-full flex justify-center items-center'>
            <div className='w-[70%] flex gap-7 justify-between [&>*:nth-child(2)]:mt-20 [&>*:nth-child(3)]:mt-32 '>
         ...
         <section className='w-full flex justify-center items-center my-20 bg-slate-200 dark:bg-slate-950 py-16'>
            <div className='flex justify-between gap-5 w-[70%]'>
               <div className='w-[]'>
                  <h1 className='text-bold text-4xl dark:text-slate-200 break-words lg:tracking-wide leading-none font-monteserat font-bold mb-3'>Why you need digital marketing</h1>
         ...
         <section className='w-full min-h-[20rem] flex justify-center items-center my-20 bg-slate-200 dark:bg-slate-950 py-16'>
            <div className='flex flex-col w-[80%] gap-5'>
               <div className='flex gap-5 justify-between items-center rounded-3xl min-[20rem]'>
                  <div className={`bg-[#6d71e5] px-7 py-5 rounded-[2.5rem] w-[15rem] flex flex-col items-start justify-center`}>
               ...
               <div className='w-full flex p-8 bg-[#b0d8d6] rounded-[1.5rem]'>
                  <div className={`bg-[url('../assets/person-using-laptop1.jpg')] h-[15rem] w-[30%]`} />
         ...
         <section className='w-full flex justify-center items-center my-20 bg-slate-200 dark:bg-slate-950 py-16'>
            <div className='flex flex-row-reverse justify-between gap-10 w-[70%]'>
               <div className='w-[]'>
         ...
         <section className='w-full flex justify-center items-center'>
            <div className='w-[70%] flex gap-7 justify-between [&>*:nth-child(2)]:mt-20 [&>*:nth-child(1)]:mt-32 '>
               {services.map((service) => (
                  <div >
                     <motion.div
                        initial={service.initial}
